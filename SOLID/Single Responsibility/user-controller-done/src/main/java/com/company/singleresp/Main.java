...
public class Main {
	...
	private static final String VALID_USER_JSON = "{\"name\": \"mehdiZebhi\", \"email\": \"mehdizebhi@yahoo.com\", \"address\":\"yazd, iran\"}";
	
	//Invalid USER JSON String - email format wrong
	private static final String INVALID_USER_JSON = "{\"name\": \"mehdi\", \"email\": \"mehdi@email\", \"address\":\"yazd\"}";
